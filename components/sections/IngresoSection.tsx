      ...
      <div className="section-shell">
        <div className="space-y-10">
          <div className="space-y-4 text-center">
            ...
            <p className="text-center text-sm font-medium text-[var(--ink-500)]">El acceso a la plataforma se solicita por WhatsApp</p>

            <div className="grid gap-4 sm:grid-cols-2">
            <div
              className="overflow-hidden rounded-[1.8rem] border border-[#e0754a]/30 bg-[linear-gradient(135deg,#fdf8f3,#f9e8d4)] p-6 shadow-[0_14px_30px_rgba(139,94,60,0.12)]"
            >
            ...
            <div
              className="overflow-hidden rounded-[1.8rem] border border-[#4a90d9]/30 bg-[linear-gradient(135deg,#f0f7ff,#e3f2ff)] p-6 shadow-[0_14px_30px_rgba(74,144,217,0.12)]"
            >
